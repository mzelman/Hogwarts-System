...
public class HousesController {
    ...
    public String addStudent(Model model, @Valid Student student, BindingResult result,
        ...
        Student checkStudent = studentService.getStudentByFirstNameAndLastName(student.getFirstName(),
                student.getLastName());
    ...
    public String deleteStudent(Model model, @PathVariable Long houseId, @PathVariable Long studentId,
            Student student) {
